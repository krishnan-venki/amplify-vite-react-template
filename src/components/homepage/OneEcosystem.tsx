...
export const OneEcosystem = () => {
  ...
  const features: Record<string, {
    ...
    onePlatform: {
      ...
      detailText: 'Stop app-switching. Sagaa offers specialized verticals — Sagaa Money, Sagaa Healthcare, Sagaa Education, and Sagaa Life Essentials — unified in one intelligent platform that connects every aspect of your life.',
    ...
    alwaysLearning: {
      ...
      shortDesc: 'Learns from every interaction and evolves into a trusted partner guiding your interconnected life goals',
      detailHeadline: 'Grows With You Over Time',
      detailText: 'Continuously learns from your choices and patterns to provide increasingly intelligent support. Anticipates your needs, adapts to your preferences, and progressively handles routine decisions—always under your control.',
