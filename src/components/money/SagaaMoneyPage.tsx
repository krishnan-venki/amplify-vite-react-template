          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(500px, 1fr))', gap: '80px', alignItems: 'center' }}>
            <div>
              <h2 style={{ fontWeight: '100', color: 'white', marginBottom: '32px', lineHeight: '1.4', wordBreak: 'break-word', fontSize: 'clamp(48px, 5vw, 72px)', paddingTop: '0.5em' }}>
                <span>
                  <span style={{ background: 'linear-gradient(135deg, #007AFF 0%, #00D2FF 50%, #34C759 100%)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text', color: 'transparent', display: 'inline-block', verticalAlign: 'baseline', lineHeight: 'inherit', paddingBottom: '0.18em' }}>Sagaa Money</span>
                </span>
                <br />
                <span>
                  Your connected Finance ecosystem
                </span>
              </h2>
              <p style={{ fontSize: 'clamp(18px, 3vw, 28px)', fontWeight: '100', marginBottom: '48px', color: '#d1d5db', maxWidth: '1024px', margin: '0 auto 48px auto', lineHeight: '1.6' }}>
                Transforms financial stress into confidence — unifying accounts, investments, and budgets into one intelligent platform that understands your spending patterns, predicts cash flow, and evolves into your autonomous financial partner
              </p>
            </div>
            <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
              <img src={heroImage} alt="Sagaa Money Hero" style={{ maxWidth: '100%', width: '760px', height: 'auto', borderRadius: '0', boxShadow: 'none', background: 'none', margin: 0, padding: 0, objectFit: 'contain', display: 'block' }} />
            </div>
          </div>
        </div>
      </section>
