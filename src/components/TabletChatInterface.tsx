...
export function ChatInterface({ messages, showTyping, isSendingAnimation = false, userTypingText = '', isUserTyping = false }: ChatInterfaceProps) {
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Category Icons - Distributed evenly */}
        <div
          style={{
            display: 'flex',
            alignItems: 'center',
